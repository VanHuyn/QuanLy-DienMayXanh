...
import SupplierImportListWarehouse from "../../components/warehouse/SupplierImportListWarehouse";
import { useState } from "react";

export default function SupplierImportManagementWarehouse() {
  ...
  return (
    <div className="p-6">
      ...
      <SupplierImportListWarehouse
        imports={imports}
        onViewDetail={(id) => navigate(`/warehouse/supplier-imports/${id}`)}
      />
    </div>
  );
}
